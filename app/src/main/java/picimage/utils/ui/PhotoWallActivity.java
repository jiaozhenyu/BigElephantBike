...
import picimage.utils.adapter.PhotoWallAdapter;
...
public class PhotoWallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        confirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(PhotoWallActivity.this, MeetQuestion.class);
    ...
    private ArrayList<String> getLatestImagePaths(int maxCount) {
        ...
        if (cursor != null) {
            Log.d("read","the last is not null");
            //从最新的图片开始读取.
